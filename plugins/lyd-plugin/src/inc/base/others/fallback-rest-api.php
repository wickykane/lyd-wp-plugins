...
if (!function_exists('lyd_skip_rest_admin_notice')) {
    /**
     ...
     */
    function lyd_skip_rest_admin_notice() {
        if (current_user_can('install_plugins')) {
            $data = get_plugin_data(LYD_FILE, true, false);
            global $wp_version;
...
add_action('admin_notices', 'lyd_skip_rest_admin_notice');
